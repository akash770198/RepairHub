...
export const PageBanner: React.FC<PageBannerProps> = ({ bannerData }) => {
  return (
    <section className="relative w-full bg-[#111c2d] pt-24 pb-0 overflow-hidden min-h-[300px] flex items-center">
