...
export const DynamicIcon: React.FC<IconProps> = ({ name, className = "w-5 h-5", size = 24 }) => {
  ...
  switch (name) {
    ...
    case "play":
      return (
        <svg {...defaultProps} fill="currentColor">
    ...
    case "user-cog":
      return (
        <svg {...defaultProps}>
          {/* Badge Outline */}
          <rect width="14" height="17" x="5" y="5" rx="2" ry="2" />
          {/* Top Clip */}
          <path d="M9 3h6" />
          <path d="M12 3v2" />
          {/* User Head */}
    ...
    case "youtube":
      return (
        <svg {...defaultProps}>
          <path d="M2.5 7.1C2.6 5.3 4.1 3.9 6 3.8c3.9-.1 8.1-.1 12 0 1.9.1 3.4 1.5 3.5 3.3.1 1.6.1 3.2 0 4.8-.1 1.8-1.6 3.2-3.5 3.3-3.9.1-8.1.1-12 0-1.9-.1-3.4-1.5-3.5-3.3-.1-1.6-.1-3.2 0-4.8z" />
